...
SECRET_KEY = 'django-insecure-ynlfku%jxndjzify8vlc7d12st)u*e1e_7nf4le4!g^(@^*2sg'
...
MIDDLEWARE = [
    ...
    # 'bus_reservation_app.LoginCheckMiddleware.LoginCheckMiddleware',
]
...
AUTH_USER_MODEL = 'bus_reservation_app.CustomUser'
